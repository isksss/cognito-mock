...
export default defineEventHandler(async event => {
  try {
    ...
    switch (body.action) {
      ...
      case 'createUser': return { user: createUser(body.poolId, body.username, body.password, { email: body.email || body.username }, body.confirmed === false ? 'UNCONFIRMED' : 'CONFIRMED') }
